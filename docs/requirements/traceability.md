...
| P5-PROFILE-LIFECYCLE | Profiles support create/list/show/clone/rename/delete/diff/activate/deactivate/run/export/import/restore/doctor | ADR-0008 | `profile-manager.js`, CLI | lifecycle and concurrent run tests | M4 Profile manifest | `docs/user/profiles-and-runtimes.md` | M4 lifecycle verified; export/import/restore belongs to M5 |
...
| P5-RUNTIME-PIN | Profiles may pin/unpin exact DSH versions and display policy, resolved version, latest, and status | ADR-0008 | Runtime/Profile managers | latest and exact-pin E2E | M4 Profile manifest | Runtime guide | implemented; explicit unpin command pending |

...
| R-CLIENT-BUILD | closed for rc.7 | reproduce unpublished client bundle format, publish `lib/typert.host.js`, and pass loader/browser tests; see M7 manifest |
...
| R-BROWSER-ACCEPT | closed for tested surface | live Web transactions, stale/disconnect paths, semantic accessibility, focus, refresh, and responsive evidence; see M7 manifest |
